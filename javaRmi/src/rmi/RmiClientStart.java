...
public class RmiClientStart {
	...
	public static void main(String[] args) throws MalformedURLException, RemoteException, NotBoundException {
		HelloService service = (HelloService) Naming.lookup("rmi://189.48.80.221:1099/hello");
		UtilsService utils = (UtilsService) Naming.lookup("rmi://189.48.80.221:1100/utils");
